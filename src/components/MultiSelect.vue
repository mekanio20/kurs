                    ...
                    <div class="flex flex-auto flex-wrap">
                            ...
                            <div class="flex flex-auto flex-row-reverse">
                                <div @click="removeTag(index)">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-4 h-4 ml-2 cursor-pointer hover:text-m_yellow-100" fill="none"
                        ...
                        <div class="flex-1">
                            <input v-model="searchQuery"
                                class="bg-transparent py-3 px-2 appearance-none outline-none h-full w-full text-white" />
                        </div>
                    </div>
                    <div class="text-gray-300 w-10 py-1 pl-3 pr-2 border-l flex items-center border-m_black-400">
...
export default {
    ...
    methods: {
        ...
        selectTag(tag) {
            ...
            this.options.splice(this.selectedTags.findIndex(item => item.id === tag.id), 1)
            this.selectedTags = this.options
            this.$emit('selectedTags', [...this.selectedTags, tag]);
            this.searchQuery = '';
        },
        removeTag(index) {
