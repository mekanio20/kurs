<template>
    <div class="w-full min-h-screen relative overflow-hidden">
        <div class="absolute left-0 -bottom-40">
            <svg width="580" height="861" viewBox="0 0 580 861" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="-33.5267" cy="899.913" rx="613.473" ry="899.913" fill="url(#paint0_radial_585_4648)"
                    fill-opacity="0.13" />
                <defs>
                    <radialGradient id="paint0_radial_585_4648" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(-33.5267 899.913) rotate(90) scale(899.913 613.473)">
        ...
        <div class="absolute right-0 top-0">
            <svg width="538" height="1024" viewBox="0 0 538 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="613.473" cy="590.913" rx="613.473" ry="899.913" fill="url(#paint0_radial_585_4649)"
                    fill-opacity="0.13" />
                <defs>
                    <radialGradient id="paint0_radial_585_4649" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(613.473 590.913) rotate(90) scale(899.913 613.473)">
                        <stop stop-color="#FFC300" />
                        <stop offset="1" stop-color="#181C27" stop-opacity="0" />
                    </radialGradient>
                </defs>
            ...
            <div class="container bg-transparent mt-40 pb-10">
                <div class="w-full flex md:flex-row flex-col items-stretch">
                    <div class="md:w-[550px] w-full lg:p-10 md:p-8 p-6 bg-m_black-500 rounded-xl lg:mr-10 md:mr-5 mb-2">
                        ...
                        <div
                            ...
                            <div @click="section = 1" class="flex items-center space-x-6 group cursor-pointer">
                                ...
                                <div :class="[section === 1 ? 'text-m_yellow-100' : 'text-white']"
                            ...
                            <div @click="logout" class="flex items-center space-x-6 group cursor-pointer">
                                <svg class="md:w-[25px] w-[20px] stroke-red-500 group-hover:stroke-m_red-200 duration-300"
                                    ...
                                    <path d="M10 13.3333V10" stroke-width="1.3" stroke-linecap="round"
                    ...
                    <div class="w-full min-h-[500px] p-10 bg-m_black-500 rounded-xl">
                        <div v-if="section === 1" class="w-full flex-col md:space-y-10 space-y-5">
                            <div class="md:flex hidden items-center space-x-6">
                                ...
                                <div class="font-sf_pro font-bold lg:text-3xl text-2xl text-white">
                                    Редактировать профиль
                                </div>
                            </div>
                            <div
                                class="flex md:flex-row flex-col md:space-y-0 space-y-6 items-center lg:space-x-16 md:space-x-10 md:pt-10 pb-4">
                                <div class="w-24 h-24">
                                    <img class="w-full h-full rounded-full object-cover" :src="avatar">
                                </div>
                                ...
                                <div @click="selectImage"
                                    ...
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke-linejoin="round" />
                                        <path d="M19.2497 13.7501L14.6663 9.16675L4.58301 19.2501" stroke="white"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M7.79199 9.16675C8.55138 9.16675 9.16699 8.55114 9.16699 7.79175C9.16699 7.03236 8.55138 6.41675 7.79199 6.41675C7.0326 6.41675 6.41699 7.03236 6.41699 7.79175C6.41699 8.55114 7.0326 9.16675 7.79199 9.16675Z"
                                            stroke="white" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                    <div>Изменить</div>
                            ...
                            <div class="flex flex-col space-y-2 lg:w-2/3 w-full">
                                ...
                                <textarea v-model="bio"
                                    class="w-full bg-m_black-300 px-8 py-4 rounded-lg font-sf_pro font-normal sm:text-lg text-sm text-white focus:outline-none focus:ring-1 focus:ring-m_yellow-200 focus:border-transparent resize-none"
                        ...
                        <div v-if="section === 2" class="w-full flex flex-col space-y-4">
                            <div class="md:flex hidden items-center space-x-6">
                                <svg class="md:w-[25px] w-[20px] stroke-white" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_585_5094)">
                                        <path
                                            d="M10 12.5C11.3807 12.5 12.5 11.3807 12.5 10C12.5 8.61929 11.3807 7.5 10 7.5C8.61929 7.5 7.5 8.61929 7.5 10C7.5 11.3807 8.61929 12.5 10 12.5Z"
                            ...
                            <div class="flex flex-col space-y-2 pt-16">
                                <label class="font-sf_pro font-normal text-m_gray-100 sm:text-base text-sm">Электронная
                                    почта</label>
                                <input v-model="email"
                                    class="lg:w-2/3 w-full bg-m_black-300 px-8 py-4 rounded-lg font-sf_pro font-normal sm:text-lg text-sm text-white focus:outline-none focus:ring-1 focus:ring-m_yellow-200 focus:border-transparent"
                                    type="email">
                            ...
                            <div class="flex flex-col space-y-2 pt-8 pb-10">
                                <label
                                    class="font-sf_pro font-normal text-m_gray-100 sm:text-base text-sm">Пароль</label>
...
export default {
    ...
    methods: {
        ...
        async setData() {
            ...
            this.avatar = this.user?.avatar || '/imgs/person6.png'
